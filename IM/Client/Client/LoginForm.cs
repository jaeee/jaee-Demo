...
namespace Client
{
    public partial class LoginForm : Form
    {
        ...
        private IPEndPoint clientIPEndPoint;//创建套接字
        ...
        public LoginForm()
        {
            ...
            txtserverIP.Text = localIP[6].ToString();
            txtLocalIP.Text = localIP[6].ToString();
            // 随机指定本地端口
        ...
        private void btnlogin_Click(object sender, EventArgs e)
        {
            ...
            // 启动发送线程
            Thread sendThread = new Thread(SendMessage);//SendMessage (更新用户表)
                ...
                try
                {
                    ...
                    switch (splitstring[0])
                    {
                        ...
                        case "login":
                            ...
                            AddItemToListView(userItem);//添加用户表
                            break;
                        case "logout":
